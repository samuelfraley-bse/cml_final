"""
XGBoost V4 - High-Risk Diagnosis Flags

Changes from V3:
1. ✓ All V3 features (enhanced diagnosis, core vitals)
2. ✓ NEW: High-risk condition flags (sepsis, respiratory failure, shock, acute MI, CHF)
   - More specific than chapter level
   - Clinically meaningful high-mortality conditions

Run from project root:
    python scripts/classification/xgb_v4_high_risk_flags.py
"""
...
print("="*80)
print("XGBOOST V4 - HIGH-RISK DIAGNOSIS FLAGS")
print("="*80)
print("\n✨ New in V4:")
print("  ✓ All V3 features (enhanced diagnosis, core vitals)")
print("  ✓ NEW: High-risk condition flags")
print("    - Sepsis")
print("    - Respiratory failure")
print("    - Shock")
print("    - Acute MI (heart attack)")
print("    - Heart failure (CHF)")
print()
...
print("\n" + "="*80)
print("STEP 2: MERGE DIAGNOSIS DATA (V4 - WITH HIGH-RISK FLAGS)")
print("="*80)
...
# Add high-risk diagnosis flags (V4 NEW)
print("\n[Adding high-risk diagnosis flags...]")
...
print(f"\n✓ After high-risk flags - Train: {train_with_dx.shape}, Test: {test_with_dx.shape}")
...
output_file = output_dir / "xgb_v4_high_risk_flags.csv"
...
print("\n" + "="*80)
print("SUMMARY - V4 HIGH-RISK DIAGNOSIS FLAGS")
print("="*80)
...
print(f"\n✨ V4 Enhancements:")
print(f"  ✓ All V3 features (enhanced diagnosis + core vitals)")
print(f"  ✓ NEW: 5 high-risk condition flags")
print(f"    - Sepsis (high mortality)")
print(f"    - Respiratory failure (ICU-specific)")
print(f"    - Shock (critical condition)")
print(f"    - Acute MI (heart attack)")
print(f"    - Heart failure (CHF)")
