"""
XGBoost V5 - Charlson Comorbidity Index + More High-Risk Flags

Changes from V4:
1. ✓ All V4 features (enhanced diagnosis, core vitals, 5 high-risk flags)
2. ✓ NEW: Charlson Comorbidity Index (validated clinical score)
   - Established mortality predictor from medical literature
   - Weights conditions by mortality risk (MI=1, AIDS=6, etc.)
3. ✓ NEW: 6 additional high-risk flags
   - Acute kidney injury, pneumonia, stroke, PE, ARDS, GI bleeding

Run from project root:
    python scripts/classification/xgb_v5_charlson.py
"""
...
print("="*80)
print("XGBOOST V5 - CHARLSON INDEX + MORE HIGH-RISK FLAGS")
print("="*80)
print("\n✨ New in V5:")
print("  ✓ All V4 features (enhanced diagnosis, core vitals, 5 high-risk flags)")
print("  ✓ NEW: Charlson Comorbidity Index")
print("    - Validated clinical score from medical literature")
print("    - Predicts 10-year mortality based on comorbidities")
print("  ✓ NEW: 6 additional high-risk flags")
print("    - Acute kidney injury, pneumonia, stroke")
print("    - Pulmonary embolism, ARDS, GI bleeding")
print()
...
output_file = output_dir / "xgb_v5_charlson.csv"
...
feature_groups = {
    ...
    'Engineered': ['shock_index', 'pulse_pressure', 'instability', 'hypoxia_and']
}
...
analysis_file = analysis_dir / "v5_feature_importance.csv"
...
print("\n" + "="*80)
print("SUMMARY - V5 CHARLSON INDEX + MORE FLAGS")
print("="*80)
...
print(f"\n✨ V5 Enhancements:")
print(f"  ✓ All V4 features (enhanced diagnosis + 5 high-risk flags)")
print(f"  ✓ NEW: Charlson Comorbidity Index")
print(f"    - Validated mortality score from medical literature")
print(f"    - Weights conditions by mortality risk")
print(f"  ✓ NEW: 6 additional high-risk condition flags")
print(f"    - Acute kidney injury (high mortality)")
print(f"    - Pneumonia (common ICU admission)")
print(f"    - Stroke (high mortality)")
print(f"    - Pulmonary embolism (life-threatening)")
print(f"    - ARDS (severe lung injury)")
print(f"    - GI bleeding (common complication)")
